...
**Distinctions**: These distinctions offer the users the ability to quickly nagivate to inspiration posts, follow along on other users' projects, learn about techniques used by others, and a way to label their posts so their questions may be replied to. 

## Fine-Tuning Pipeline ##
The base model used is distilbert-base-uncased, a lightweight pre-trained transformer model from HuggingFace. Fine-tuning was performed on Google Colab using a free T4 GPU. 
